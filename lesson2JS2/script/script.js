...
class GoodsList {
    ...
    fetchGoods() {
        this.goods = [
            { title: 'Карамель', price: 300, src: 'images/candy-1678933_640.jpg' },
            { title: 'Шоколад', price: 400, src: 'images/chocolates-491165_1920.jpg' },
            { title: 'Леденец', price: 500, src: 'images/lollipop-3185313_640.jpg' }
        ];
    }
}
